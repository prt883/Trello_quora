...
public class AnswerController {
    ...
    public ResponseEntity<AnswerResponse> createAnswer(@PathVariable("questionId") String questionId, final AnswerRequest answerRequest, @RequestHeader("authorization") final String authorization) throws AuthenticationFailedException, InvalidQuestionException {
    ...
    public ResponseEntity<AnswerResponse> editByAnswerId(@PathVariable("answerId") String answerId, final AnswerEditRequest answerEditRequest, @RequestHeader("authorization") final String authorization) throws AuthenticationFailedException,AnswerNotFoundException {
    ...
    public ResponseEntity<AnswerDeleteResponse> deleteAnswerByAnswerId(@PathVariable("answerId") String answerId, @RequestHeader("authorization") final String authorization) throws AuthenticationFailedException, AnswerNotFoundException {
    ...
    public ResponseEntity<List<AnswerDetailsResponse>> getAnswersByQuestionId(@PathVariable("questionId") String questionId, @RequestHeader("authorization") final String authorization) throws AuthenticationFailedException, InvalidQuestionException {
