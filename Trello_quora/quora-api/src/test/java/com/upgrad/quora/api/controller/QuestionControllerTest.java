...
public class QuestionControllerTest {
    ...
    public void createQuestionWithSignedOutUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/question/create?content=my_question").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "Bearer database_accesstoken"))
                .andExpect(status().isForbidden())
    ...
    public void getAllQuestions() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/question/all").header("authorization", "Bearer database_accesstoken"))
    ...
    public void editNonExistingQuestion() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/question/edit/non_exisitng_question_uuid?content=edited_question").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "Bearer database_accesstoken"))
    ...
    public void getAllQuestionsForNonExistingUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/question/all/non_existing_user_uuid").header("authorization", "Bearer database_accesstoken"))
                .andExpect(status().isNotFound())
